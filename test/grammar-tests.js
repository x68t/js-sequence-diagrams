...
function assertSingleArrow(d, leftArrowtype, rightArrowtype, linetype, actorA, actorB, message) {
  ...
  equal(d.signals[0].rightArrowtype, rightArrowtype, 'Right arrowhead type');
  equal(d.signals[0].leftArrowtype, leftArrowtype, 'Left arrowhead type');
...
test('Comments', function() {
  ...
  assertSingleArrow(Diagram.parse('A->B#: Message'), ARROWTYPE.NONE, ARROWTYPE.FILLED, LINETYPE.SOLID, 'A', 'B#');
  assertSingleArrow(Diagram.parse('A<-B#: Message'), ARROWTYPE.FILLED, ARROWTYPE.NONE, LINETYPE.SOLID, 'A', 'B#');
  assertSingleArrow(Diagram.parse('A->B: Message # not a comment'), ARROWTYPE.NONE, ARROWTYPE.FILLED,
      LINETYPE.SOLID, 'A', 'B', 'Message # not a comment');
  assertSingleArrow(Diagram.parse('A<-B: Message # not a comment'), ARROWTYPE.FILLED, ARROWTYPE.NONE,
      LINETYPE.SOLID, 'A', 'B', 'Message # not a comment');
...
test('Quoted names', function() {
  assertSingleArrow(Diagram.parse('"->:"->B: M'), ARROWTYPE.NONE, ARROWTYPE.FILLED, LINETYPE.SOLID,
      '->:', 'B', 'M');
  assertSingleArrow(Diagram.parse('A->"->:": M'), ARROWTYPE.NONE, ARROWTYPE.FILLED, LINETYPE.SOLID,
      'A', '->:', 'M');
