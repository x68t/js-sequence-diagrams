...
var parser = function() {
    ...
    var o = function(k, v, o, l) {
        ...
        return o;
    }, $V0 = [ 5, 8, 9, 13, 15, 24 ], $V1 = [ 1, 13 ], $V2 = [ 1, 17 ], $V3 = [ 1, 21 ], $V4 = [ 1, 22 ], $V5 = [ 1, 31 ], $V6 = [ 1, 32 ], $V7 = [ 24, 30, 31 ], $V8 = [ 28, 29 ], parser = {
        trace: function() {},
        yy: {},
        symbols_: {
            error: 2,
        ...
        productions_: [ 0, [ 3, 2 ], [ 4, 0 ], [ 4, 2 ], [ 6, 1 ], [ 6, 1 ], [ 7, 2 ], [ 7, 1 ], [ 7, 1 ], [ 7, 2 ], [ 12, 4 ], [ 12, 4 ], [ 19, 1 ], [ 19, 3 ], [ 16, 1 ], [ 16, 1 ], [ 11, 4 ], [ 17, 1 ], [ 10, 1 ], [ 23, 1 ], [ 23, 2 ], [ 23, 2 ], [ 23, 3 ], [ 25, 1 ], [ 25, 1 ], [ 26, 1 ], [ 26, 1 ], [ 27, 1 ], [ 27, 1 ], [ 14, 1 ] ],
        ...
        table: [ o($V0, [ 2, 2 ], {
            ...
            21: [ 1, 27 ],
            22: [ 1, 28 ]
        }, o([ 20, 28, 29, 32, 33, 34 ], [ 2, 17 ]), o($V0, [ 2, 6 ]), o($V0, [ 2, 18 ]), o($V0, [ 2, 9 ]), o($V0, [ 2, 29 ]), {
            17: 29,
            24: $V1
        }, {
            24: [ 2, 19 ],
            ...
            28: $V3,
            29: $V4
        }, o($V7, [ 2, 23 ]), o($V7, [ 2, 24 ]), o($V8, [ 2, 27 ]), o($V8, [ 2, 28 ]), {
            17: 34,
            24: $V1
        }, {
            17: 36,
...
if (typeof Snap != 'undefined') {
  ...
  _.extend(SnapTheme.prototype, BaseTheme.prototype, {
    ...
    drawLine: function(x1, y1, x2, y2, linetype, leftArrowhead, rightArrowhead) {
        console.log('--1');
        console.log(leftArrowhead, rightArrowhead);
        ...
        if (arrowhead !== undefined) {
          console.log('left');
          console.log(this.arrowMarkers_.left[arrowhead]);
          line.attr('markerStart', this.arrowMarkers_.left[arrowhead]);
        }
        arrowhead = rightArrowhead;
        if (arrowhead !== undefined) {
          console.log('right');
          console.log(this.arrowMarkers_.right[arrowhead]);
