...
_.extend(BaseTheme.prototype, {
  ...
  drawSelfSignal: function(signal, offsetY) {
      ...
      this.drawLine(aX, y1, aX + SELF_SIGNAL_WIDTH, y1, signal.linetype, signal.leftArrowtype);
      this.drawLine(aX + SELF_SIGNAL_WIDTH, y1, aX + SELF_SIGNAL_WIDTH, y2, signal.linetype);
      this.drawLine(aX + SELF_SIGNAL_WIDTH, y2, aX, y2, signal.linetype, undefined, signal.rightArrowtype);
    },
  ...
  drawSignal: function(signal, offsetY) {
    ...
    this.drawLine(aX, y, bX, y, signal.linetype, signal.leftArrowtype, signal.rightArrowtype);
  },
